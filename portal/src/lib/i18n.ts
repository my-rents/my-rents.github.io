...
export const portalTranslations: Record<PortalLanguage, PortalCopy> = {
  en: {
    ...
    landingTitle: 'Your lease portal.',
    ...
    portalUpdatedDetail: 'Last time tenant logged in',
  ...
  es: {
    ...
    expenses: 'Gastos',
    factGallery: 'Imágenes compartidas con acciones para previsualizar, abrir y descargar.',
    factMetadata:
      'Los accesos del inquilino quedan registrados para el propietario en los metadatos del portal.',
    factPayments: 'La próxima fecha de cobro y si el alquiler está pagado o vencido.',
    factSharedDocuments: 'Documentos compartidos disponibles para abrir en una nueva pestaña.',
    featurePasscodeText:
      'Propietario e inquilino usan códigos distintos. No hace falta cuenta personal, correo ni registro.',
    featurePasscodeTitle: 'Acceso por código',
    featureRentVisibilityText:
      'El portal muestra la próxima fecha de cobro y si el alquiler está totalmente pagado o vencido.',
    featureRentVisibilityTitle: 'Visibilidad del alquiler',
    featureSharedText:
      'Cada ruta del portal corresponde a un solo contrato, para que documentos, imágenes y gastos queden ligados al inquilino correcto.',
    ...
    landingIntro:
      'My Rents envía a cada contrato su propio enlace del portal y sus códigos. Abre la URL exacta del correo recordatorio, elige tu rol e inicia sesión con el código asignado a este contrato.',
    landingTitle: 'Tu portal del contrato.',
    leaseIdLabel: 'ID del contrato',
    leaseIdPlaceholder: 'Pega el ID del contrato del enlace del portal',
    leaseLinkMissing: 'Falta un ID de contrato válido en el enlace.',
    ...
    loadingLeaseText:
      'Los archivos compartidos, imágenes, gastos y estado de pago están en camino.',
    loadingLeaseTitle: 'Cargando el resumen del contrato',
    localQaShortcut: 'Acceso rápido QA local',
    nextImage: 'Imagen siguiente',
    nextPayday: 'Próximo cobro',
    noDocumentsText: 'El propietario aún no ha publicado documentos de este contrato en el portal.',
    noDocumentsTitle: 'Aún no hay documentos compartidos',
    noExpensesText: 'Este contrato no expone gastos en el portal por ahora.',
    noExpensesTitle: 'No hay gastos compartidos',
    noGalleryText: 'Las imágenes aparecerán aquí cuando se publiquen en este contrato.',
    noGalleryTitle: 'No hay imágenes compartidas',
    ...
    portalUpdatedDetail: 'Última vez que el inquilino inició sesión',
    preparingZip: 'Preparando ZIP...',
    previousImage: 'Imagen anterior',
    published: 'Publicado',
    rentAmount: 'Importe del alquiler',
    rentAmountLoadingDetail: 'Se mostrará cuando cargue el resumen del contrato.',
    restoringSessionText: 'El portal está comprobando si este navegador ya tiene acceso.',
    restoringSessionTitle: 'Restaurando la sesión del contrato',
    ...
    sessionExpired:
      'La sesión de este contrato ha caducado. Vuelve a iniciar sesión con el código.',
    sharedExpenseTotal: 'Total de gastos compartidos',
    sharedItems: 'Elementos compartidos',
    sharedItemsDetail: 'Documentos e imágenes visibles para este contrato.',
    sharedLeasePortal: 'Portal del contrato compartido',
    signInDescription:
      'Elige el rol que corresponde a tu código. El propietario y el inquilino usan códigos distintos incluso en el mismo contrato.',
    signInToLease: (leaseId) => `Inicia sesión en el contrato ${leaseId}`,
    ...
    tenantLastCheckIn: 'Último acceso del inquilino',
    unlockLeasePortal: 'Abrir portal del contrato',
    upcomingPayment: 'Próximo pago',
    upcomingPaymentDetail: (date) => `El siguiente cobro está previsto para ${date}.`,
  ...
  de: {
    ...
    portalUpdatedDetail: 'Letzter Login des Mieters',
  ...
  fr: {
    ...
    landingTitle: 'Votre portail de bail.',
    ...
    portalUpdatedDetail: 'Dernière connexion du locataire',
  ...
  it: {
    ...
    landingTitle: 'Il tuo portale del contratto.',
    ...
    portalUpdatedDetail: 'Ultimo accesso dell’inquilino',
  ...
  pt: {
    ...
    landingTitle: 'O seu portal do contrato.',
    ...
    portalUpdatedDetail: 'Último acesso do inquilino',
